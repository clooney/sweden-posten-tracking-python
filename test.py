...
#urlStr = "/sweden-posten/RE272293485SE"
...
#urlStr = ""
#requestData = "{\"tracking_number\": \"RE272293485SE\",\"carrier_code\":\"sweden-posten\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}"
#result = tracker.trackingmore(requestData, urlStr, "realtime")

#10 Modify courier code(修改运输商)
#urlStr = ""
#requestData = "{\"tracking_number\": \"RE272293485SE\",\"carrier_code\":\"sweden-posten\",\"update_carrier_code\":\"china-ems\"}"
...
#urlStr = ""
#requestData = "[{\"tracking_number\":\"RE272293485SE\",\"carrier_code\":\"sweden-posten\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"sweden-posten\"}]"
...
#urlStr = ""
#requestData = "[{\"carrier_code\":\"sweden-posten\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]"
#result = tracker.trackingmore(requestData, urlStr, "costtime")

#16 Delete multiple tracking item(批量删除)
#urlStr = ""
#requestData = "[{\"tracking_number\":\"RE272293485SE\",\"carrier_code\":\"sweden-posten\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]"
